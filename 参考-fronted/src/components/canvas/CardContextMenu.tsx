...
export function CardContextMenu({ 
  ...
  const menuItems: MenuItem[] = [
    { id: 'copy', label: '复制卡片', icon: Copy, action: onDuplicate },
    ...
    { id: 'camera', label: '镜头运镜', icon: Camera, action: onCameraMove },
    { id: 'divider2', label: '', icon: Copy, action: () => {}, divider: true },
    { id: 'inpaint', label: '局部重绘(Inpaint)', icon: Paintbrush, action: onInpaint },
    { id: 'outpaint', label: '智能扩图(Outpaint)', icon: Expand, action: onOutpaint },
    { id: 'virtualCamera', label: '虚拟摄像机', icon: Camera, action: onVirtualCamera },
