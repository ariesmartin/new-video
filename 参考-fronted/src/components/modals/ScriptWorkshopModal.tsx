...
风沙更大了，瞬间吞没了他单薄的身影，只留下一串歪歪扭扭的脚印，迅速被新的尘埃掩埋。`;
  ...
  return (
    ...
    >
      <div 
        className="w-full max-w-6xl h-[90vh] rounded-xl overflow-hidden flex flex-col"
          ...
          >
            <div className="p-4">
              ...
              <div className="space-y-1">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <span 
                        className="text-xs"
                        style={{ 
                          color: activeChapter === index ? 'var(--primary)' : 'var(--text-tertiary)'
                        }}
                      >
                        {chapter.id}
                      </span>
                      <span 
                        ...
                        style={{ 
                          color: activeChapter === index ? 'var(--primary)' : 'var(--text-primary)'
                        }}
                      >
                        {chapter.title}
                  </span>
                ...
                <button 
                  className="w-full p-3 rounded-lg flex items-center gap-2 hover:bg-white/5 transition-colors mt-2"
                  style={{ color: 'var(--text-tertiary)' }}
                >
